...
export const handleKeyboardDidShow = (event, TextInputState, textInputAnimate) => {
  ...
  const currentlyFocusedField =  TextInputState.currentlyFocusedInput ? findNodeHandle(TextInputState.currentlyFocusedInput()) : TextInputState.currentlyFocusedInput();
